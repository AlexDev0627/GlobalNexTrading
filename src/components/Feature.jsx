...
export default () => {
    ...
    const features = [
        ...
        },
        {
            ...
            desc: "Gestionamos los riesgos aduaneros y logísticos para que tú te enfoques en lo que mejor sabes hacer: hacer crecer tu negocio."
        }
    ]

    return (
        <section className="relative py-32 overflow-hidden bg-black">
            {/* Fondo con imagen y overlay de gradiente avanzado */}
            <div className="absolute inset-0 z-0">
                <img
                    src={image}
                    alt="Background"
                    className="w-full h-full object-cover opacity-50 bg-fixed"
                />
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                    ...
                    <div className="lg:col-span-5">
                        ...
                        >
                            <span className="inline-block px-4 py-1.5 mb-6 text-[10px] font-medium tracking-[0.2em] text-lime-400 uppercase bg-lime-500/10 border border-lime-500/20 rounded-full">
                                ¿Por qué elegirnos?
                            </span>
                            ...
                            <p className="text-xl text-gray-300 font-light leading-relaxed mb-10">
                                En un mercado globalizado, la diferencia entre sobrevivir y liderar es su capacidad logística. Al elegirnos, su empresa obtiene un aliado estratégico comprometido con su éxito internacional.
                            </p>

                            <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="px-8 py-4 bg-lime-500 text-black font-bold rounded-2xl shadow-xl shadow-lime-500/20 hover:bg-lime-400 transition-all flex items-center gap-3"
                            >
                                Descubrir Más
                    ...
                    {/* Contenido Derecho - Cuadrícula de Beneficios */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {features.map((item, idx) => (
                                <motion.div
                                    ...
                                    whileHover={{ y: -5 }}
                                    className={`p-8 rounded-[2rem] bg-white/5 backdrop-blur-xl border border-white/10 hover:border-lime-500/30 transition-all group ${idx === 2 ? 'md:col-span-2' : ''}`}
                                >
                                    <div className="w-14 h-14 rounded-2xl bg-lime-500/10 flex items-center justify-center text-lime-500 mb-6 group-hover:bg-lime-500 group-hover:text-black transition-all duration-500">
                                        {item.icon}
                                    </div>
