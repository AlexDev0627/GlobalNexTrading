...
export default () => {
    ...
    return (
        <section className="relative py-50 dark:bg-transparent">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 text-gray-300 justify-between gap-24 lg:flex md:px-8">
                <div className="max-w-xl">
                    <h3 className="text-slate-900 dark:text-white text-3xl font-semibold sm:text-4xl">
                         Eleva tu empresa con <span className="text-lime-600 dark:text-lime-400">Global Next Trading</span>
                    </h3>
                    <h4 className="mt-4 text-slate-700 dark:text-gray-300 text-lg font-medium underline decoration-lime-700">
...
En un mercado globalizado, la diferencia entre una empresa que sobrevive y una que lidera es su capacidad logística. Al elegir a <span className="underline decoration-lime-700">Global Next Trading</span>, tu empresa obtiene
                ...
                <div className="mt-12 lg:mt-0 ">
                    <ul className="grid gap-8 sm:grid-cols-2 text-slate-900 dark:text-white">
                        {
                            features.map((item, idx) => (
                                <li key={idx} className="flex gap-x-4 ">
                                    ...
                                    <div>
                                        <h4 className="text-lg text-slate-900 dark:text-white font-semibold">
                                            {item.title}
                                        </h4>
                                        <p className="mt-3">
                                            {item.desc}
