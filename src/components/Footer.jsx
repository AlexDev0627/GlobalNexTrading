...
export default () => {
    ...
    return (
        <>
             <div className="flex items-center px-6 md:px-12 py-0">
    ...
    <span className="h-px flex-1 bg-gradient-to-r from-gray-300 via-gray-300 to-transparent dark:from-slate-700 dark:via-slate-700 dark:to-transparent"></span>
        ...
        <footer className="relative pt-10 transition-colors duration-700 bg-white dark:bg-black"
                style={{
                    // Aplicamos el gradiente adaptado aquí
                    background: `
                        radial-gradient(
                            circle at top,
        ...
        >
            <div className="max-w-screen-xl mx-auto px-4 md:px-8 justify-center items-center">
                <div className="justify-between items-center gap-12 md:flex">
                    ...
                    <div className="flex justify-between px-9 w-100 items-center justify-items-center">
                        ...
                        {/* <form onSubmit={(e) => e.preventDefault()} className="flex items-center gap-x-3 md:justify-end">
                            ...
                            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-slate-800 bg-lime-400 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow">
                                Subscribe
                            </button>
                        </form> */}
                    </div>
